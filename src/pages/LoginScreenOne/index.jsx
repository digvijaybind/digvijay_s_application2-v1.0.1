              ...
              <div className="flex flex-col gap-[30px] items-start justify-start py-2 w-auto">
                ...
                <div className="flex flex-col gap-[30px] items-center justify-start w-auto sm:w-full">
                  ...
                  <div className="flex flex-col items-start justify-start w-auto sm:w-full">
                    <Button
                      className="bg-gradient2  cursor-pointer font-medium indigo_300_00_indigo_300_border2 outline outline-[1px] py-3.5 rounded-[5px] text-center text-lg text-white-A700 w-[480px]"
